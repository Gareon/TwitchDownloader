...
{
    internal class CliDefaultTaskProgress : ITaskProgress
    {
        ...
        public CliDefaultTaskProgress(LogLevel logLevel, ProgressReportStream reportStream)
        {
